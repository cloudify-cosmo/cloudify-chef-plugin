...
def get_resources_path():
    resources_path = '{0}/resources'.format(os.path.dirname(__file__))
...
class ChefPluginClientTest(TestCase):
    ...
    def setUp(self, *args, **kwargs):
        ...
        blueprint_dir = self.copy_blueprint('blueprints',
                                            blueprints_dir=resources_path)
        self.blueprint_yaml = (
        ...
        cookbook_local_path = os.path.abspath(
            os.path.join(self.copy_blueprint('blueprints',
                                             blueprints_dir=resources_path),
...
class ChefPluginSoloTest(TestCase):
    ...
    def setUp(self, *args, **kwargs):
        ...
        self.blueprint_dir = self.copy_blueprint(
                'blueprints',
                blueprints_dir=get_resources_path())
